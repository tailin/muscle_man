...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { amount: @practice.amount, bar_type: @practice.bar_type, moving: @practice.moving, rest: @practice.rest, unit: @practice.unit } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { amount: @practice.amount, bar_type: @practice.bar_type, moving: @practice.moving, rest: @practice.rest, unit: @practice.unit } }
